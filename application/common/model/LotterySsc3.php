...
class LotterySsc3 extends Base
{
    ...
    public function getInfoByLimitTime()
    {
        $info   = $this->limit(1)->order('id desc')->find();
    ...
    public function getListByLimitTime()
    {
        $list   = $this->limit(3)->order('id desc')->select();
