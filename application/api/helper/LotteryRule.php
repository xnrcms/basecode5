...
class LotteryRule extends Base
{
    ...
    private $mainTable          = 'lottery_rule';
    ...
    private function saveData($parame)
    {
        ...
        $saveData                       = [];
        $saveData['lottery_title']      = isset($parame['lottery_title']) ? $parame['lottery_title'] : '';
        $saveData['title']              = isset($parame['title']) ? $parame['title'] : '';
        $saveData['description']        = isset($parame['description']) ?  $parame['description'] : '';
        $saveData['odds']               = isset($parame['odds']) ? $parame['odds'] : '';
        $saveData['odds2']              = isset($parame['odds2']) ? $parame['odds2'] : '';
        $saveData['odds_rebate']        = isset($parame['odds_rebate']) ? $parame['odds_rebate'] : '';
        $saveData['difference_value']   = isset($parame['difference_value']) ? $parame['difference_value'] : 0;
        $saveData['status']             = 1;
        ...
        cache('getLotterRule_config',null);
    ...
    private function quickEditData($parame)
    {
        ...
        //根据ID更新数据
        $updata                         = isset($parame['updata']) ? json_decode($parame['updata'],true) : [];
    	$info 				            = $dbModel->saveLotteryOdds($updata);
